...
window = sg.Window('ICA', layout, font=TextFont)
...
class Spider(scrapy.Spider):
    ...
    def CheckForIngredients(self, response, headerNumber):
        ...
        if response.xpath(
                "/html/body/div[1]/div/div[1]/div[2]/main/div/div[1]/div/div[2]/div[2]/div/div/div/div[1]/div/div/span/text()").get() == "Glutenfritt" and values['-KEYWORDS-'] == "Gluten":
            print(Fore.GREEN + "Gluten Free")
            print(Style.RESET_ALL)
            AllergenFree = True
            self.PrintResult("Gluten Free Certification", AllergenFree)
            return
        elif response.xpath("/html/body/div[1]/div/div[1]/div[2]/main/div/div[1]/div/div[2]/div[2]/div/div/div/div[2]/div/div/span/text()").get() == "Laktosfritt" and values['-KEYWORDS-'] == "Lactose":
