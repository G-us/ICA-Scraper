...
def SearchICA(InputURL):
    ...
    print("Searching at url: " + InputURL)
    driver.get(InputURL)
    driver.delete_all_cookies()     
    WebDriverWait(driver, 10).until(element_to_be_clickable((By.ID, "onetrust-accept-btn-handler")))
    CookiesBtn = driver.find_element(By.ID, "onetrust-accept-btn-handler")
    CookiesBtn.click()
  
    WebDriverWait(driver, 10).until(visibility_of_element_located((By.XPATH, "//*[contains(text(), 'Ingredienser')]")))
    productName = driver.find_element(By.XPATH, 
        "/html/body/div[1]/div/div[1]/div[2]/main/div/div[1]/div/div[2]/div/div[1]/h1").text
    
    ingredients = driver.find_element(By.XPATH, "//*[contains(text(), 'Ingredienser')]/following-sibling::*").text
    print(ingredients)
...
#     while i < 10:
#         headerTitle = driver.find_element(By.XPATH,
#             "/html/body/div[1]/div/div[1]/div[2]/main/div/div[2]/div/div/div/div[" + str(i) + "]/h2").text
